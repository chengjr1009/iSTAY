...
`iStay` (Hill-number-based measures of stability and related synchrony) is an R package for featuring a class of measures of community/ecosystem stability and related synchrony; the corresponding diversity-stability is also assessed if biodiversity data are available. The Hill-number-based measures of stability were developed based on the Hill-number parametrized by an order q > 0; see Chao et al. (2024) for the relevant theory and methodological background. All measures are illustrated by using biomass temporal data from the Jena experiment (Wagg et al. 2022).
...
output_multi_div <- data.frame(output_multi_div, log2_sowndiv=rep(c(4,3,2,1,0),8),
...
data("Jena_hierarchical_biomass_data")
data("Jena_hierarchical_mat")
output_hier_q <- Stay_Hier(data=Jena_hierarchical_biomass_data, mat=Jena_hierarchical_mat |> mutate(Species = paste0(Plot, Species)),
                           order.q=seq(0.1,2,0.1), Alltime=TRUE)
